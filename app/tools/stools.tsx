...
-- 资产负债表
REPORT_DATE: 报告期,TOTAL_PARENT_EQUITY: 归属母公司股东权益,TOTAL_ASSETS: 资产总计,TOTAL_CURRENT_ASSETS: 流动资产合计,TOTAL_NONCURRENT_ASSETS: 非流动资产合计,TOTAL_CURRENT_LIAB:流动负债合计,TOTAL_NONCURRENT_LIAB: 非流动负债合计,TOTAL_LIABILITIES: 负债合计,CONTRACT_LIAB: 合同负债,ADVANCE_RECEIVABLES: 预收款项,NOTE_ACCOUNTS_PAYABLE: 应付票据及应付账款,PREPAYMENT:预付款项,NOTE_ACCOUNTS_RECE:应收票据及应收账款
-- 资产负债表-按报告期
